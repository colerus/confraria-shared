...
export const validarTelefone = (telefone: Telefone | string | PhoneNumber): boolean => {
...
export const converterParaPhoneNumber = (telefone: Telefone | string | PhoneNumber | PropsTelefone): PhoneNumber => {
    if(telefone instanceof PhoneNumber) {
        return telefone;
    }
...
export const converterParaTelefone = (telefone: string | PhoneNumber | Telefone | PropsTelefone): Telefone => {
